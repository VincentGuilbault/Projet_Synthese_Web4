...
<body>
    <div class="main">
        ...
        <div class="contenu">
            ...
            <h2>Entreprises</h2>
            <h3>Formulaire pour créer une nouvelle entreprise</h3>
            <div class="formualaire_boite"><a href="{{route('entreprise.create')}}" class="formulaire">Créer une entreprise</a></div>

            <h3>Liste des entreprises existantes</h3>
            <ul>
                @foreach ($entreprises as $entreprise)
                    <li><a href="{{route('entreprise.show', $entreprise->id)}}" class="boites">{{$entreprise->nom}}</a></li>
                @endforeach
            </ul>
        </div>
    </div>
