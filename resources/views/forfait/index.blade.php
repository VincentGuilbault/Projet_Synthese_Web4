...
<body>
    <div class="main">
        ...
        <div class="contenu">
            ...
            <h2>Forfaits</h2>
            <h3>Formulaire pour créer un nouveau forfait</h3>
            <div class="formualaire_boite"><a href="{{route('forfait.create')}}" class="formulaire">Créer un forfait</a></div>

            <h3>Liste des forfaits existants</h3>
            <ul>
                @foreach ($forfaits as $forfait)
                    <li><a href="{{route('forfait.show', $forfait->id)}}" class="boites">{{$forfait->nom}}</a></li>
                @endforeach
            </ul>
        </div>
    </div>
